...
namespace tModPackager
{
    ...
    public class BuildProperties
    {
        ...
        public string[] dllReferences = new string[0];
        public ModReference[] modReferences = new ModReference[0];
        public ModReference[] weakReferences = new ModReference[0];
        //this mod will load after any mods in this list
        //sortAfter includes (mod|weak)References that are not in sortBefore
        public string[] sortAfter = new string[0];
        //this mod will load before any mods in this list
        public string[] sortBefore = new string[0];
        public string[] buildIgnores = new string[0];
